...
const FuneralsAgenda = () => {
  ...
  if (loading) {
    return (
      <div className="bg-white dark:bg-slate-800 rounded-xl p-8 shadow-sm border border-slate-100 dark:border-slate-700 text-center">
        <p className="text-slate-500 dark:text-slate-400">Chargement de l'agenda...</p>
      </div>
    );
  }
  ...
  if (funerals.length === 0) {
    return (
      <div className="bg-white dark:bg-slate-800 rounded-xl p-8 shadow-sm border border-slate-100 dark:border-slate-700 text-center">
        ...
        <p className="text-slate-500 dark:text-slate-400">Aucune cérémonie prévue pour le moment.</p>
      </div>
    );
  }
        ...
        >
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            <div className="flex-1">
              ...
              <div className="space-y-2 text-slate-600 dark:text-slate-400 dark:text-slate-400">
